...
class synthesis(Node):
	def synthesize(self, selected_origins, selected_normals, face_origins, face_normals):
		...
		res = vector_based_synth.synthesize(sel_origs, sel_norms, face_origs, face_norms)
